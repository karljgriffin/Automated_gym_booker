...
browser = webdriver.Chrome("/Users/karlgriffin/Downloads/chromedriver-2")
...
while not done:
    ...
    try:
        ...
        browser.find_element_by_xpath('//*[@id="SW300-1|3"]/td[6]/a').click()
        ...
        browser.find_element_by_xpath('//*[@id="single-column-content"]/div/div/div/div[2]/div/form/input[4]').send_keys(environ.get('student_number'), Keys.RETURN)      
